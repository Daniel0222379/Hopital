...
namespace Hospital.controllers
{
    public class MedicamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMedicamento,Nombre,Codigo,Observacion")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMedicamento,Nombre,Codigo,Observacion")] Medicamento medicamento)
        {
